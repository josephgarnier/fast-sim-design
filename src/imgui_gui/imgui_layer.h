...
namespace FastSimDesign {
  ...
  public:
    ...
    ControllerWindow& getControllerWindow() noexcept { return m_controllerWindow; }
    LogWindow& getLogWindow() noexcept { return m_logWindow; }
    ...
    void endImGuiUpdate() noexcept;

    void renderImGui(sf::RenderWindow& window) noexcept;

    /// Method to destroy Dear ImGui context.
    virtual void disposeImGui() noexcept;
  ...
  private:
    ...
    void createDockSpace() const noexcept;
    ImGuiID configureDockSpace() const noexcept;
    void configureDockNodes(ImGuiID dockspace_id) const noexcept;

  public:
  protected:
  private:
    ControllerWindow m_controllerWindow;
    LogWindow m_logWindow;

    ImVector<std::unique_ptr<ModalDialog>> m_open_modal_dialogs;
  };
}
#endif