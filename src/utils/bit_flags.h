...
namespace FastSimDesign {
  ...
  public:
    ...
    BitFlags(BitFlags const&) = default; // Copy constructor
    BitFlags(BitFlags&&) = default; // Move constructor
    BitFlags& operator=(BitFlags const&) = default; // Copy assignment operator
    BitFlags& operator=(BitFlags&&) = default; // Move assignment operator
  ...
  ////////////////////////////////////////////////////////////
  template<typename T>
  inline constexpr std::ostream& operator<<(std::ostream& stream, BitFlags<T> const& left) noexcept
  {
  ...
  template<typename T>
  inline constexpr bool operator==(BitFlags<T> const& left, BitFlags<T> const& right) noexcept
  {
