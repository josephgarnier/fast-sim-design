...
inline std::string toString(uint16_t const& type)
{
  ...
  switch (type)
  {
    case toUnderlyingType(Type::NONE):
      return "NONE";
    case toUnderlyingType(Type::SCENE_AIR_LAYER):
      return "SCENE_AIR_LAYER";
    case toUnderlyingType(Type::PLAYER_AIRCRAFT):
      return "PLAYER_AIRCRAFT";
    case toUnderlyingType(Type::ALLIED_AIRCRAFT):
      return "ALLIED_AIRCRAFT";
    case toUnderlyingType(Type::ENEMY_AIRCRAFT):
      return "ENEMY_AIRCRAFT";
    case toUnderlyingType(Type::PICKUP):
      return "PICKUP";
    case toUnderlyingType(Type::ALLIED_PROJECTILE):
      return "ALLIED_PROJECTILE";
    case toUnderlyingType(Type::ENEMY_PROJECTILE):
      return "ENEMY_PROJECTILE";
    case toUnderlyingType(Type::AIRCRAFT):
      return "AIRCRAFT";
    case toUnderlyingType(Type::PROJECTILE):
      return "PROJECTILE";
    default:
      return "UNKNOWN";
  }
