/******************************************************************************
 * The style ImGui-Spectrum is developed by Adobe : https://github.com/adobe/imgui/blob/master/docs/Spectrum.md.
 *
 * This class is a copy of https://github.com/adobe/imgui/blob/master/imgui_spectrum.h.
 ******************************************************************************/

#pragma once

#ifndef FAST_SIM_DESIGN_STYLE_SPECTRUM_H
#define FAST_SIM_DESIGN_STYLE_SPECTRUM_H
