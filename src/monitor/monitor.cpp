...
namespace FastSimDesign {
  ...
  namespace SimMonitor {
    ...
    void Monitor::initImGui(Configuration const& config, sf::RenderWindow& window) const
    {
    ...
    void Monitor::handleEvent(sf::RenderWindow& window, sf::Event const& event) const
    {
