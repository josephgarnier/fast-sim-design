...
set "PROJECT_NAME=fast-sim-design"
REM -DPROJECT_SUMMARY: short description of the project
set "PROJECT_SUMMARY=A virtual environment for fast agent-based simulation design."
REM -DPROJECT_VENDOR_NAME: project author
set "PROJECT_VENDOR_NAME=joseph-garnier"
REM -DPROJECT_VENDOR_CONTACT: author contact
set "PROJECT_VENDOR_CONTACT=garnjose@gmail.com"
